...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container green_container">
        <div class="content-container">
            ...
            <asp:GridView runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" ID="question_view" AutoGenerateColumns="False" CssClass="table " OnRowCreated="question_view_RowCreated" ShowFooter="true">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Title">
                        ...
                        <ItemTemplate>
                            <asp:TextBox ID="txbox_title" runat="server" Width="230px"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Score">

                        <ItemTemplate>
                            <asp:TextBox ID="txbox_score" runat="server" Width="50px" TextMode="Number"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Option1">
                        <ItemTemplate>
                            <asp:TextBox ID="txbox_op1" runat="server" Width="150px"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Option2">
                        <ItemTemplate>
                            <asp:TextBox ID="txbox_op2" runat="server" Width="150px"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Option3">
                        <ItemTemplate>
                            <asp:TextBox ID="txbox_op3" runat="server" Width="150px"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Option4">
                        <ItemTemplate>
                            <asp:TextBox ID="txbox_op4" runat="server" Width="150px"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Answer">
                        <ItemTemplate>
                            <asp:DropDownList ID="dropdown_answer" runat="server" AppendDataBoundItems="true" CssClass=" btn btn-outline-primary dropdown-toggle">
            ...
            <br />
            <asp:Button ID="btn_save" runat="server" Text="Save All" OnClick="btn_save_Click" CssClass="btn btn-primary float-end " UseSubmitBehavior="false" OnClientClick="this.disabled='true' ; this.value= 'Please Wait..'" />
            <br /><br />
